				...
				<div class="container">
					<div class="row">
						<div id="primary" class="col-xs-12 col-md-9">
							<h1>Blogg</h1>
							<article>
								<img src="http://localhost/labb_1/wordpress/wp-content/uploads/2021/09/washington.jpg" />
								<h2 class="title">
							...
							<article>
								<img src="http://localhost/labb_1/wordpress/wp-content/uploads/2021/09/paris.jpg" />
								<h2 class="title">
							...
							<article>
								<img src="http://localhost/labb_1/wordpress/wp-content/uploads/2021/09/london.jpg" />
								<h2 class="title">
